...
model_file = pkg_resources.resource_filename(
    ...
    'data/model-weights-spectrico-mmr-mobilenet-128x128-344FF72B.pb',
)  # path to the car make and model classifier
label_file = pkg_resources.resource_filename(
    'vehicle_detection_tracker', 'data/model_labels.txt'
