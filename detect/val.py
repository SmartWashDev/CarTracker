...
from ultralytics.yolo.utils.metrics import (
    box_iou,
    ConfusionMatrix,
    DetMetrics,
)
...
class DetectionValidator(BaseValidator):
    ...
    def preprocess(self, batch):
        ...
        self.lb = (
            [torch.cat([batch['cls'], batch['bboxes']], dim=-1)[batch['batch_idx'] == i] for i in range(nb)]
    ...
    def get_dataloader(self, dataset_path, batch_size):
        ...
        return (
            ...
            else build_dataloader(self.args, batch_size, img_path=dataset_path, stride=gs, mode='val')[0]
        )
